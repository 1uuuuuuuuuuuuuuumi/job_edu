(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("Combo00","589","17","200","45",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
            obj.set_borderRadius("5px");
            obj.set_text("Combo00");
            this.Div00.addChild(obj.name, obj);

            obj = new Grid("grid_category","126","237","244","437",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Combo("Combo00","190","38","200","45",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_borderRadius("5px");
            ...
            obj = new Grid("grid_product","400","237","756","437",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("Button00","887","186","79","44",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("조회");
            obj.set_borderRadius("5px");
            ...
            obj = new Button("Button00_00_00_00","1075","186","79","44",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("삭제");
            obj.set_borderRadius("5px");
            obj.set_font("bold 17px 맑은 고딕");
            ...
            obj = new Button("Button00_00_01","981","186","79","44",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("저장");
            obj.set_borderRadius("5px");
            obj.set_font("bold 17px 맑은 고딕");
            ...
            obj = new Button("Button01","294","196","35","35",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("+");
            obj.set_borderRadius("5px");
            this.addChild(obj.name, obj);

            obj = new Button("Button02","334","196","35","35",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("-");
            obj.set_borderRadius("5px");
            this.addChild(obj.name, obj);

            obj = new Static("Static00_00","33","38","167","41",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("•카테고리코드");
            ...
            obj = new Static("Static00_00_00","447","38","167","41",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("•카테고리명");
            obj.set_textAlign("center");
            obj.set_font("bold 15pt \"돋움\"");
            ...
            obj = new BindItem("item0","grid_category","autofittype","gds_userInfo","");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","grid_category","binddataset","ds_category","");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("Form_ProductList_copy0.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.grid_category.addEventHandler("oncellclick",this.Div00_Grid00_oncellclick,this);
            ...
            this.Button02.addEventHandler("onclick",this.Div00_Button02_onclick,this);
        };
        this.loadIncludeScript("Form_ProductList_copy0.xfdl");
