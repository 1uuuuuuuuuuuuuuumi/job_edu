(function()
{
    return function()
    {
        ...
        {
            this.set_name("Form_ShippingStatus");
            ...
            obj = new BindItem("item1","Div00.form.Edit01","value","ds_search","PROD_NAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","Div00.form.Combo00","value","ds_search","ORDER_STATUS");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.loadIncludeScript("Form_ShippingStatus.xfdl");
